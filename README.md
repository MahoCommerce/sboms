...
1. Enumerates public, non-archived, non-fork mahocommerce repos via the GitHub API.
2. For each repo, clones the default branch (and the latest release tag, if present) and runs Syft.
